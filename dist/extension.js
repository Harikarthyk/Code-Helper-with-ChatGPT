...
const nonce_1 = __webpack_require__(43);
class SidebarProvider {
    ...
    _getHtmlForWebview(webview) {
        const scriptUri = webview.asWebviewUri(vscode.Uri.joinPath(this._extensionUri, "out", "compiled/sidebar.ts"));
...
const vscode = __webpack_require__(41);
const SidebarProvider_1 = __webpack_require__(42);
...
async function activate(context) {
    ...
    context.subscriptions.push(vscode.window.registerWebviewViewProvider("codeHelper-sidebar", sidebarProvider));
